...
1. **Домен маскировки** — выберите домен, под который будет маскироваться трафик:
   - `cloudflare.com` (рекомендуется)
   - `1c.ru`, `sberbank.ru`, `yandex.ru` и др.
   - Или введите свой

2. **Порт прокси** — по умолчанию `443` (HTTPS)
